      ...
      <Row className="human-resources">
        <Col span={20}>
          <div className="div-human-add">
            <Link className="human-add" to="register">İşçi əlavə et</Link>
          </div>

          <Row className="human-card-row">
            <Col className="human-card-col gutter-row">
              <HumanCard/>
            </Col>
            <Col className="human-card-col gutter-row">
              <HumanCard/>
        ...
        <Col span={4}>
          <div className="human-search">
            ...
            <input type="text" className="search-personal" placeholder="Personal" />
            <select className="search-select" name="" id="" placeholder="Şirkət">
              
              <option disabled={true} value="">Şirkət</option>
            </select>
            <select className="search-select" name="" id="" placeholder="Ofis"></select>
            <select className="search-select" name="" id="" placeholder="Departament"></select>
            <select className="search-select" name="" id="" placeholder="Vəzifə"></select>
            <select className="search-select" name="" id="" placeholder="Ə/H növü"></select>

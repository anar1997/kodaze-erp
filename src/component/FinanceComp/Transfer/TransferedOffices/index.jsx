...
import { postOfficesAsync } from "../../../../redux/slices/Financeİnstallment/Transfer/officesSlice";
...
const TransferedOffices = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(postOfficesAsync(values));
    },
  });
    ...
    <form action="" onSubmit={formik.handleSubmit}>
      ...
      <div className="transfer-company">
        ...
        <div className="transfer-blank">
          ...
          {formik.errors.sending_office_id && (
            <div className="error-2">{formik.errors.sending_office_id}</div>
          )}
          <div className="transfer-company-parametr">
          ...
          {formik.errors.receiving_office_id && (
            <div className="error-2">{formik.errors.receiving_office_id}</div>
          )}
          <div className="transfer-company-parametr">
            <label>Məbləğ *</label>
            <input
          ...
          <div className="transfer-button">
            ...
            <button className="transfer-button-2">Əlavə et</button>
          </div>
        </div>
      </div>
    </form>
...
export default TransferedOffices;
